...
if __name__ == "__main__":
    ...
    X_train, y_train, landmarks_train = load_data_with_landmarks(emotions, "/home/dominika/wsi-318409-lab5/train")
    X_test, y_test, landmarks_test = load_data_with_landmarks(emotions, "/home/dominika/wsi-318409-lab5/test")
    ...
    for run in range(runs):
        ...
        trained_model, train_losses, val_losses = train_model(X_train, y_train, model, epochs=10, batch_size=64)
    ...
    file_name = "complex_RAFDB_results_lr0,001_epochs10_batch64_warstwy3.txt"
